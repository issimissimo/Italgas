    ...
    public class CustomDropdown : MonoBehaviour, IPointerExitHandler, IPointerEnterHandler, IPointerClickHandler
    {
        ...
        public void SetupDropdown()
        {
            ...
            for (int i = 0; i < dropdownItems.Count; ++i)
            {
                ...
                {
                    ChangeDropdownInfo(index = go.transform.GetSiblingIndex(), false);
        ...
        public void ChangeDropdownInfo(int itemIndex, bool callEvent = true)
        {
            ...
            if(callEvent) dropdownEvent.Invoke(itemIndex);
        }
