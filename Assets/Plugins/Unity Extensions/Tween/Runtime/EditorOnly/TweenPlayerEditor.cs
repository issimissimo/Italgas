...
namespace UnityExtensions.Tween
{
    public partial class TweenPlayer
    {
        ...
        internal class Editor : BaseEditor<TweenPlayer>
        {
            ...
            SerializedProperty _onForwardStartedProp;
            ...
            void OnEnable()
            {
                ...
                _onForwardStartedProp = serializedObject.FindProperty(nameof(_onForwardStarted));
            ...
            public override void OnInspectorGUI()
            {
                ...
                {
                    EditorGUILayout.PropertyField(_onForwardStartedProp);
                    GUILayout.Space(2);
