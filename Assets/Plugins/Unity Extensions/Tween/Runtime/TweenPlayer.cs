...
namespace UnityExtensions.Tween
{
    ...
    public partial class TweenPlayer : ConfigurableUpdateComponent
    {
        ...
        [SerializeField] UnityEvent _onForwardStarted = default;
        ...
        /// </summary>
        public event UnityAction onForwardStarted
        {
            add => (_onForwardStarted ?? (_onForwardStarted = new UnityEvent())).AddListener(value);
            remove => _onForwardStarted?.RemoveListener(value);
        }
